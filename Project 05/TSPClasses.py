...
class State:
    # initialize with the cost (lowerbound), reduced distance matrix, current route, and the total number of cities
    # to calculate priority
    def __init__(self, cost, matrix, route, nCities):
        self.cost = cost
        self.matrix = matrix
        self.route = route
        self.priority = cost * (nCities / len(self.route))
    ...
    # determines how to compare two State objects
